...
SRC = $(addprefix $(SRCS_DIR), free.c init.c main.c  parse.c texture.c error.c  minimap.c  key.c map.c raycasting.c movement.c floor_cell.c fill_space.c ray_utils.c)
